...
//! [`Transitions::set_transition_settings`](crate::client::Transitions::set_transition_settings).
...
pub enum AudioMonitoring {
    ...
    /// local machine.
    MonitorOff = 0,
    /// The opposite of [`Self::MonitoringOff`], playing the audio locally but not sending it to
    /// the stream.
    MonitorOnly = 1,
